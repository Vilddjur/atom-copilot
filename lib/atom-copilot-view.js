...
export default class AtomCopilotView {
  constructor(serializedState) {
    // Create root element
    this.element = document.createElement('div');
    this.element.classList.add('atom-copilot');
  ...
  loadLang(copyToClipboard, modalPanel){
    ...
    if(out !== null){
      ...
      close.onclick = function(){modalPanel.hide();};
  ...
  getNextWord(json, index, words){
    if (json.hasOwnProperty("examples")){
